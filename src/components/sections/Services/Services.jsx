...
const PRICING = [
  ...
  {
    heading: "Косметика DrowHer",
    img: [popup_4_1Jpg, popup_4_2Jpg, popup_4_3Jpg],
    text: [
      [
        "У салоні Ви можете придбати натуральну китайську косметику DrowHer, в основі якої лежать активні компоненти, що з легкістю проникають у клітину і впливають на основні її складові. ",
        "",
      ],
      [
        "Наші спеціалісти з радістю допоможуть Вам у виборі правильного догляду!",
        "",
      ],
    ],
  },
